...
const ctx={document:{getElementById:i=>els[i]||null,createElement:()=>El('t'),
  ...
  console,setTimeout:(f)=>{},clearTimeout(){},Math,Date,JSON,Number,String,Object,Array,
  matchMedia:()=>({matches:false}),fetch:async()=>({ok:true,json:async()=>({}),text:async()=>''}),
  alert(){},prompt(){return null},confirm(){return false},open(){},scrollTo(){},AbortController:class{constructor(){this.signal={}}abort(){}}};
...
S.locked=false;
S.state={version:'v15',llm:true,linked:true,transactions:161,agents:[],connections:[],instruments:[],findings:[],runs:[]};
...
S.save={verifiedTotalCents:0,events:[],opportunities:[],recurringAnnualCents:0};
